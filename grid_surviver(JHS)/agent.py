...
class DeepQNetwork:
    def __init__(self, n_features=ob_size, actions=3, epsilon=0.9, decay = 0.9999, min_epsilon=0.2, gamma=0.99, lr=0.0001, batch_size = 64, update_freq=1000, buffer_size=200000, device='cpu'):
    ...
    def learn(self):
        if len(self.memory) < 50000: return # 충분한 버퍼 체크
