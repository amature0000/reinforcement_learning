...
def process_reward(state:State, next_state:State):
    ...
    # getting closer to B
    if state.b_stat[0][2] > next_state.b_stat[0][2]: 
        if state.b_stat[1][2] > next_state.b_stat[1][2]: return 0.4
        else: return 0.2
    elif state.b_stat[1][2] > next_state.b_stat[1][2]: return 0.2
    # or run away from K
    if state.k_stat[0][2] < next_state.k_stat[0][2]: return 0.05
    return 0
